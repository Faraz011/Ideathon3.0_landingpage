...
const SPONSOR_LOGOS = {
  GOOGLE: "https://www.gstatic.com/images/branding/product/1x/goog_on_white/googleg.svg",
  ...
  FIGMA: "https://s3-alpha.figma.com/hub/file/1481185752847/fa4cd348-ba8f-470f-a583-b46162f463d0-cover",
  ...
  DOCKER: "https://www.docker.com/wp-content/uploads/2023/08/Docker-Temporary-Logo.png",
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 sm:mb-20">
          <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 rounded-full border border-yellow-500/30 bg-yellow-400/10">
            ...
            <span className="text-sm font-semibold text-yellow-300">Our Partners</span>
          </div>
          ...
          <p className="mt-6 text-lg sm:text-xl text-gray-300/80 max-w-3xl mx-auto leading-relaxed">
            We're honored to collaborate with innovative companies that share our vision
            for creating amazing experiences
          </p>
        </div>
            ...
            >
              ...
              <div
                className={`flex flex-col items-center justify-center h-48 sm:h-56 rounded-2xl p-4 sm:p-6 transition-all duration-500 ease-out transform
                  ...
                  ${hoveredIndex === index ? "bg-gradient-to-br from-yellow-400/20 to-amber-400/10" : "bg-white/5"}
                  border ${hoveredIndex === index ? "border-yellow-400/60" : "border-yellow-500/20"}
              ...
              >
                ...
                <div
                  className={`flex items-center justify-center w-20 h-20 sm:w-24 sm:h-24 mb-4 rounded-xl transition-all duration-500 relative z-10
                    ${hoveredIndex === index ? `bg-gradient-to-br ${color} shadow-lg scale-110` : "bg-white/10"}
                  `}
                >
                  <img
                    src={logo}
                    ...
                    style={{
                      filter: hoveredIndex === index ? "drop-shadow(0 0 8px rgba(212, 175, 55, 0.6))" : "drop-shadow(0 0 4px rgba(212, 175, 55, 0.2))",
                    }}
                  />
                </div>
                ...
                <div className="text-center relative z-10">
                  <p
                    className={`font-bold text-sm sm:text-base transition-all duration-300 ${
                      hoveredIndex === index ? "text-yellow-300 text-lg" : "text-white"
                    }`}
                  >
                    {name}
                  </p>
                  <p
                    className={`text-xs sm:text-sm mt-2 transition-all duration-300 ${
                      hoveredIndex === index ? "text-yellow-200/90 opacity-100" : "text-gray-400/60 opacity-0"
                    }`}
                  >
                    {title}
                  </p>
